...
function onSuccess(imageURI) 
{
    ...
    var pic4 = document.getElementById("photofour");
    var pic5 = document.getElementById("photofive");
    var pic6 = document.getElementById("photosix");
...
function Next()
{
    ...
    else if(currentsrc===pic3.src)
    {
        document.getElementById("slideshowpicid").src=pic4.src;
    }
    else if(currentsrc===pic4.src)
    {
        document.getElementById("slideshowpicid").src=pic5.src;
    }
    else if(currentsrc===pic5.src)
    {
        document.getElementById("slideshowpicid").src=pic6.src;
    }
    else
    {
...
function endslideshow()
{
    ...
    pic4.src="images/EmptyBox-Phone.png";
    pic5.src="images/EmptyBox-Phone.png";
    pic6.src="images/EmptyBox-Phone.png";
